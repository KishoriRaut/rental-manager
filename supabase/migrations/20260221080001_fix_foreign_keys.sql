-- Fix foreign key constraints by ensuring auth.users exists first
...
-- Recreate houses table with proper foreign key
...
-- Recreate tenants table with proper foreign keys
...
-- Recreate monthly billing table with proper foreign keys
